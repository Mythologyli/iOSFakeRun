...
namespace iOSFakeRun
{
    internal static class Image
    {
        public static bool MountImage(iDeviceHandle iDevice, LockdownClientHandle lockdownClient, string iosVersion)
        {
            ...
            if (lockdownInstance.lockdownd_start_service(lockdownClient, "com.apple.mobile.mobile_image_mounter", out var lockdownServiceDescriptor) != LockdownError.Success)
            {
                return false;
            }
